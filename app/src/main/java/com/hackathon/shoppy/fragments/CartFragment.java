    ...
    public void onStart() {
        ...
        uidref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                DatabaseReference imageref = FirebaseDatabase.getInstance().getReference("Products").child(location[0]);
                ...
                FirebaseRecyclerAdapter<Cart, CartViewHolder> adapter = new FirebaseRecyclerAdapter<Cart, CartViewHolder>(
                    ...
                    protected void populateViewHolder(CartViewHolder holder, Cart cart, int i) {
                        ...
                        final double[] totalproductprice = {Double.valueOf(cart.getPrice()) * Double.valueOf(cart.getQuantity())};
                            ...
                            public void onClick(View v) {
                                ...
                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int i) {
                                        if (i == 0){
                                            try {
                                                DatabaseReference locationref = FirebaseDatabase.getInstance().getReference("Users").child(firebaseUser.getUid()).child("location");
                                                ...
                                                DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Products").child(location[0]).child(cart.getPid());
                                                reference.addValueEventListener(new ValueEventListener() {
                                                    @Override
                                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                        img1= dataSnapshot.child("image1").getValue(String.class);
                                                        img2 = dataSnapshot.child("image2").getValue(String.class);
                                                        img3 = dataSnapshot.child("image3").getValue(String.class);
